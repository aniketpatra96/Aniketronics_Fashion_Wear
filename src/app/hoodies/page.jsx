...
const Hoodies = () => {
  const hoodies = use(productService.fetchProducts("Hoody"));
  const colorSet = new Set();
  hoodies.forEach((hoody) => {
    const colorObj = hoody.color;
        ...
        <div className="flex flex-wrap m-4">
          {hoodies.map((hoody) => {
            return (
              ...
              >
                <Link
                  href={`/product?slug=${hoody.slug}&category=${hoody.category}`}
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="mt-1">₹{hoody.price}</p>
